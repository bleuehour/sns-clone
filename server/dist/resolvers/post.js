...
let PostResolver = class PostResolver {
        ...
        return __awaiter(this, void 0, void 0, function* () {
         ...
         `, [RealValue, postId, userId]);
          ...
          where _id =$2`, [2 * RealValue, postId]);
                ...
                yield (0, typeorm_1.getConnection)().transaction((tm) => __awaiter(this, void 0, void 0, function* () {
                    yield tm.query(`insert into "up_doot" ("userId","postId",value)
    ...
    deletePost(_id, { req }) {
        return __awaiter(this, void 0, void 0, function* () {
            yield Post_1.Post.delete({ _id, creatorId: req.session.userId });
            return true;
        });
    }
};
